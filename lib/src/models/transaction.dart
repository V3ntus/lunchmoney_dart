...
class Transaction implements LunchMoneyModel {
  ...
  Transaction({
    ...
    required this.recurringPayee,
    required this.recurringDescription,
    required this.recurringCadence,
    ...
    required this.assetInstitutionName,
    required this.assetName,
    required this.assetDisplayName,
    required this.assetStatus,
    required this.plaidAccountId,
    required this.plaidAccountName,
    required this.plaidAccountMask,
    required this.institutionName,
    required this.plaidAccountDisplayName,
    required this.plaidMetadata,
